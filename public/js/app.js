...
app.controller('LoginController', function($scope, $rootScope, $localStorage, $sessionStorage, $location, $http){
    ...
    $scope.submitLogin = function(){
        ...
        $http({
            ...
            .success(function(response){
                ...
                console.log("token at login: ", $rootScope.token);
                $location.path('/');
            })
            .error(function(){
...
app.controller('ProtectedController', function($scope, $rootScope, $localStorage, $location, $http){

    
    console.log("token at prot. controller: ", $rootScope.token);
